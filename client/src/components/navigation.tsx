  ...
  return (
    <nav className="border-b bg-white/95 dark:bg-gray-900/95 dark:border-gray-700 backdrop-blur-sm sticky top-0 z-10">
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex justify-center space-x-1 py-2 sm:py-4 overflow-x-auto">
          {navItems.map((item) => (
            <motion.button
              key={item.value}
              ...
              className={`flex items-center space-x-1 sm:space-x-2 px-3 py-2 sm:px-6 sm:py-3 rounded-xl font-medium transition-all duration-200 text-xs sm:text-base whitespace-nowrap ${
