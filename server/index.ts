...
const strictLimiter = rateLimit({
  ...
  message: {
    error: "Rate limit exceeded for this action, please wait before trying again."
  },
  standardHeaders: true,
  legacyHeaders: false,
});
...
app.use('/api/reset-data', strictLimiter);
app.use('/api/habits/*/progress', strictLimiter);
